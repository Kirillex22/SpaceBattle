...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="один из векторов содержит пустое значение")]
        [Xunit.TraitAttribute("FeatureTitle", "вектор")]
        [Xunit.TraitAttribute("Description", "один из векторов содержит пустое значение")]
        public void ОдинИзВекторовСодержитПустоеЗначение()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("один из векторов содержит пустое значение", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 10
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
            ...
            else
            {
                this.ScenarioStart();
#line 11
testRunner.Given("двумерный вектор, одна из координат которого пуста", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Дано ");
#line hidden
#line 12
testRunner.And("вектор с координатами (1, 3)", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "И ");
#line hidden
#line 13
testRunner.When("происходит сложение векторов", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Когда ");
#line hidden
